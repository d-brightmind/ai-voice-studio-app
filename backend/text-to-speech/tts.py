...
app = modal.App("ai-voice-studio-ridwan")
...
volume = modal.Volume.from_name("hf-cache-ai-studio", create_if_missing=True)
...
@app.cls(
    ...
    volumes={
        ...
        "/s3-mount": modal.CloudBucketMount("ai-voice-studio-ridwan", secret=s3_secret),
    },
